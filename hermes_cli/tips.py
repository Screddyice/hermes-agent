...
TIPS = [
    ...
    "hermes memory setup lets you configure an external memory provider such as Honcho.",
    ...
    "External memory providers include Honcho, OpenViking, Hindsight, and more.",
