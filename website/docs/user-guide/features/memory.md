...
For deeper, persistent memory that goes beyond MEMORY.md and USER.md, Hermes ships with seven external memory provider plugins: Honcho, OpenViking, Hindsight, Holographic, RetainDB, ByteRover, and Supermemory.
